...
$base_file_name = 'settings_offtime_type_value_listing';
...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<a href='settings_offtime_type_value_save.php?settingsofftimetypeid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>✎</a> 
		<a href='settings_offtime_type_value_view.php?settingsofftimetypeid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>☷</a> 
		</td>
		</tr>
		";
	}
...
<body id='page-listing'>
    ...
    <section id='sub-menu'>
        ...
        <div class='right-block'>
            ✢ <a href='settings_offtime_type_value_save.php' target='overlay-iframe' onclick='overlayOpen();'>New
                Off-time Type</a>
        </div>
    </section>
