...
<body id='page-view' class='page_view page_trips_view'>
	...
	<?php 
		...
		if ($concluded_checkbox != 'on') {
			print "<h3 class='center'><a href='trips_conclude_save.php?tripsid=$key_trips' target='overlay-iframe2' onclick='overlayOpen2();'>Conclude trip # $key_trips</a></h3>";
		} else if ($settled_checkbox != 'on') {
			print "<h3 class='center'><a href='trips_payroll_settlement_save.php?tripsid=$key_trips' target='overlay-iframe2' onclick='overlayOpen2();'>Settle trip # $key_trips</a></h3>";
			...
			print "
			<form class='center' method='post'>
				<p><a href='customer_invoices_print_single.php?customer_invoicesid=$key_customer_invoices' target='_blank'>View Invoice # $key_customer_invoices</a></p>
