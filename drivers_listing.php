...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<li><a href='drivers_save.php?driversid=$record_id' target='overlay-iframe' onclick='overlayOpen();hide_record_menus();'>Edit</a></li>
		<li><a href='drivers_view.php?driversid=$record_id' target='overlay-iframe' onclick='overlayOpen();hide_record_menus();'>View</a></li>
		<li><a href='trips_listing.php?driversid=$record_id' target='_blank' onclick='hide_record_menus();'>Trips</a></li>
