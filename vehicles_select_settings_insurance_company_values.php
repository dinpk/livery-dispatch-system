	...
	if ($results) {
		...
		while ($row = mysqli_fetch_assoc($results)) {
			...
			<td class='record-icons'>
				...
				<a href='settings_insurance_company_values_view.php?settings_insurance_company_valuesid=" . $row['key_settings_insurance_company_values'] . "' target='overlay-iframe3' onclick='overlayOpen3();'>View</a> 
			</td>
			</tr>
				";
		}
	...
	<main>
		<section id='search-forms'>
			<form method='get'>
				...
				<input type='submit' value='Search'> &nbsp; <a href='settings_insurance_company_values_save.php' target='overlay-iframe3' onclick='overlayOpen3();'>Add new</a>
			</form>
		</section>
		<?php 
