...
$base_file_name = 'settings_trip_type_value_listing';
...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<a href='settings_trip_type_value_save.php?settingstriptypeid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>✎</a> 
		<a href='settings_trip_type_value_view.php?settingstriptypeid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>☷</a> 
		</td>
		</tr>
		";
	}
...
<html>
<head>
    <title>SETTINGS - TRIP TYPES</title>
...
<body id='page-listing'>
    ...
    <section id='sub-menu'>
        ...
        <div class='right-block'>
            ✢ <a href='settings_trip_type_value_save.php' target='overlay-iframe' onclick='overlayOpen();'>New Trip
                Type</a>
        </div>
    </section>
