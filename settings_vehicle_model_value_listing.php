...
$base_file_name = 'settings_vehicle_model_values_listing';
...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<a href='settings_vehicle_model_value_save.php?settings_vehicle_model_valuesid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>✎</a> 
		<a href='settings_vehicle_model_value_view.php?settings_vehicle_model_valuesid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>☷</a> 
		</td>
		</tr>
		";
	}
...
<body id='page-listing' class='page_listing page_settings_vehicle_model_values_listing'>
	<?php include('php/_header.php'); ?>
	<section id='sub-menu'>
		<div class='left-block'><img src="images/icons/set_vehicle_models.png"> settings - vehicle models</div>
		<div class='right-block'>
			✢ <a href='settings_vehicle_model_value_save.php' target='overlay-iframe' onclick='overlayOpen();'>New Vehicle Model</a>
		</div>
	</section>
