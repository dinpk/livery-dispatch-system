...
$base_file_name = 'vehicle_listing';
...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<td class='record-menus'>
			...
			<li><a href='vehicle_save.php?vehicleid=$record_id' target='overlay-iframe' onclick='overlayOpen();hide_record_menus();'>Edit</a></li>
			<li><a href='vehicle_view.php?vehicleid=$record_id' target='overlay-iframe' onclick='overlayOpen();hide_record_menus();'>View</a></li>
			<li><a href='vehicle_maintenance_listing.php?vehicleid=$record_id' target='_blank' onclick='hide_record_menus();'>Maintenance</a></li>
			<li><a href='trip_listing.php?vehicleid=$record_id' target='_blank' onclick='hide_record_menus();'>Trips</a></li>
			</ul>
		</td>
		</tr>
			";
