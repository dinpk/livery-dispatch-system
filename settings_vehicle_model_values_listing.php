...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<a href='settings_vehicle_model_values_view.php?settings_vehicle_model_valuesid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>☷</a> 
		</td>
		</tr>
		";
	}
...
<body id='page-listing' class='page_listing page_settings_vehicle_model_values_listing'>
	...
	<section id='sub-menu'>
		...
		<div class='right-block'>
			✢ <a href='settings_vehicle_model_values_save.php' target='overlay-iframe' onclick='overlayOpen();'>New Vehicle Model</a>
		</div>
	</section>
