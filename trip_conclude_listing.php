...
$base_file_name = 'trip_conclude_listing';
...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<a href='trip_conclude_save.php?tripid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>✎</a> 
		</td>
		</tr>
		";
	}
...
<body id='page-listing'>
    ...
    <div class='page-image' style='background-image:url(images/page-conclude.jpg);'></div>
