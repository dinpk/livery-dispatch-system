...
if (isset($_GET['settings_country_valuesid'])) {
	...
	if (isset($_GET['delete'])) {
		$results = mysqli_query($dbcon, "DELETE FROM settings_country_values WHERE key_settings_country_values = $record_id");
		if ($results) {
...
<body id='page-delete' class='page_delete page_settings_country_values_delete'>
