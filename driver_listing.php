...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<li><a href='driver_save.php?driverid=$record_id' target='overlay-iframe' onclick='overlayOpen();hide_record_menus();'>Edit</a></li>
		<li><a href='driver_view.php?driverid=$record_id' target='overlay-iframe' onclick='overlayOpen();hide_record_menus();'>View</a></li>
		<li><a href='trip_listing.php?driverid=$record_id' target='_blank' onclick='hide_record_menus();'>Trips</a></li>
		<li><a href='driver_payroll_listing.php?driverid=$record_id' target='_blank' onclick='hide_record_menus();'>Payroll</a></li>
		</ul>
		</td>
		</tr>
		";
