...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<a href='settings_insurance_company_value_save.php?settings_insurance_company_valuesid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>✎</a> 
		<a href='settings_insurance_company_value_view.php?settings_insurance_company_valuesid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>☷</a> 
		</td>
		</tr>
		";
	}
...
<body id='page-listing' class='page_listing page_settings_insurance_company_values_listing'>
	...
	<section id='sub-menu'>
		...
		<div class='right-block'>
			✢ <a href='settings_insurance_company_value_save.php' target='overlay-iframe' onclick='overlayOpen();'>New Insurance Company</a>
		</div>
	</section>
