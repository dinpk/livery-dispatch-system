...
if (isset($_GET['settings_landmark_valuesid'])) {
	...
	if (isset($_GET['delete'])) {
		$results = mysqli_query($dbcon, "DELETE FROM settings_landmark_values WHERE key_settings_landmark_values = $record_id");
		if ($results) {
...
<body id='page-delete' class='page_delete page_settings_landmark_values_delete'>
