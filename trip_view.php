	...
	<main>
		<div class="flex">
            <section>
                ...
                <div class="view_h4"><?php print date("M d, Y", strtotime($dropoff_date)); ?> (<?php print $dropoff_time; ?>)</div>
                <br>
            ...
            <section>
                <table>
                    ...
                    <tr><td colspan="3"><hr></td></tr>
                    <tr>
                        <td colspan="2"><div class="view_h2 view_label">Total trip amount</div></td>
                        <td><div class="view_h1"><?php print number_format($total_trip_amount, 2); ?></div></td>
                    </tr>
                </table>
            </section>
        </div>
