...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<a href='settings_trip_status_value_save.php?settings_trip_status_valuesid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>✎</a> 
		<a href='settings_trip_status_value_view.php?settings_trip_status_valuesid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>☷</a> 
		</td>
		</tr>
		";
	}
...
<body id='page-listing' class='page_listing page_settings_trip_status_values_listing'>
	...
	<section id='sub-menu'>
		...
		<div class='right-block'>
			✢ <a href='settings_trip_status_value_save.php' target='overlay-iframe' onclick='overlayOpen();'>New Trip Status</a>
		</div>
	</section>
