...
$base_file_name = 'settings_trip_status_value_listing';
...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<a href='settings_trip_status_value_view.php?settingstripstatusid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>☷</a> 
		</td>
		</tr>
		";
	}
...
<body id='page-listing'>
    ...
    <section id='sub-menu'>
        ...
        <div class='right-block'>
            ✢ <a href='settings_trip_status_value_save.php' target='overlay-iframe' onclick='overlayOpen();'>New Trip
                Status</a>
        </div>
    </section>
