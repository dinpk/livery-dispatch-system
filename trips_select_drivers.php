...
if ($run_query) {
	...
	if ($results) {
		...
		while ($row = mysqli_fetch_assoc($results)) {
			...
			<a href='drivers_view.php?driversid=" . $row['key_drivers'] . "' target='overlay-iframe3' onclick='overlayOpen3();'>View</a> 
			</td>
			</tr>
			";
		}
	...
	<main>
		<section id='search-forms'>
			<form method='get'>
					...
					<input type='submit' value='Search'> &nbsp; <a href='drivers_save.php' target='overlay-iframe3' onclick='overlayOpen3();'>Add new</a>
			</form>
		</section>
		<?php 
