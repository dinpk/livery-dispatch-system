...
$base_file_name = 'settings_extra_charges_value_listing';
...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<a href='settings_extra_charges_value_save.php?settingsextrachargeid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>✎</a> 
		<a href='settings_extra_charges_value_view.php?settingsextrachargeid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>☷</a> 
		</td>
		</tr>
		";
	}
...
<body id='page-listing'>
    ...
    <section id='sub-menu'>
        ...
        <div class='right-block'>
            ✢ <a href='settings_extra_charges_value_save.php' target='overlay-iframe' onclick='overlayOpen();'>New Extra
                Charge</a>
        </div>
    </section>
