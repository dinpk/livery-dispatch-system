...
if (isset($_GET['customer_invoicesid'])) {
	...
	if (isset($_GET['delete'])) {
		$results = mysqli_query($dbcon, "DELETE FROM customer_invoices WHERE key_customer_invoices = $record_id");
		if ($results) {
...
<body id='page-delete' class='page_delete page_customer_invoices_delete'>
