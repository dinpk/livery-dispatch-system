...
<body id='page-save'>
    ...
    <main>
        ...
        <form method='post'>
            <fieldset>
                <div>
                    <label for='ad_source'>Ad source</label> <span class='red'> *</span>
                    <?php if(isset($msg_ad_source)) print $msg_ad_source; ?>
                    <input id='ad_source' name='ad_source' type='text'
                        value='<?php if (isset($ad_source)) {print $ad_source;} else { print '';} ?>' required><br>
                </div>
