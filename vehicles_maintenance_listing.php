...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<td class='record-icons'>
			<small>
			<a href='vehicles_maintenance_save.php?vehicles_maintenanceid=$record_id&vehiclesid=$parent_id' target='overlay-iframe' onclick='overlayOpen();'>✎</a> 
			<a href='vehicles_maintenance_view.php?vehicles_maintenanceid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>☷</a> 
			</small>
		</td>
		</tr>
		";
