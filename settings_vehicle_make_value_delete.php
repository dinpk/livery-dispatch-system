...
if (isset($_GET['settings_vehicle_make_valuesid'])) {
	...
	if (isset($_GET['delete'])) {
		$results = mysqli_query($dbcon, "DELETE FROM settings_vehicle_make_values WHERE key_settings_vehicle_make_values = $record_id");
		if ($results) {
...
<body id='page-delete' class='page_delete page_settings_vehicle_make_values_delete'>
