	...
	if ($results) {
		...
		while ($row = mysqli_fetch_assoc($results)) {
			...
			<td class='record-icons'>
				...
				<a href='rate_zone_view.php?rates_zonesid=" . $row['key_rates_zones'] . "' target='overlay-iframe3' onclick='overlayOpen3();'>View</a> 
			</td>
			</tr>
			";
		}
	...
	<main>
		<section id='search-forms'>
			<form method='get'>
				...
				<input type='submit' name='search' value='Search'> &nbsp; <a href='rate_zone_save.php' target='overlay-iframe3' onclick='overlayOpen3();'>Add new</a>
			</form>
		</section>
		<?php 
