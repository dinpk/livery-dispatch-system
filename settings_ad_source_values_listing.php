...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<a href='settings_ad_source_values_save.php?settings_ad_source_valuesid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>✎</a> 
		<a href='settings_ad_source_values_view.php?settings_ad_source_valuesid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>☷</a> 
		</td>
		</tr>
		";
	}
