...
<body id='page-save'>
    ...
    <main>
        ...
        <form method='post'>
            <fieldset>
                <input id='key_customer_passengers' name='key_customer_passengers' type='hidden'
                ...
                <div>
                    ...
                    <input id='start_date' name='start_date' type='date' placeholder='yyyy-mm-dd'
                        value='<?php if (isset($start_date)) {print $start_date;} ?>' required readonly><br>
                </div>
                <div>
                    <label for='end_date'>End date</label> <span class='red'> *</span><br>
                    <?php if(isset($msg_end_date)) print $msg_end_date; ?>
                    <input id='end_date' name='end_date' type='date' placeholder='yyyy-mm-dd'
                        value='<?php if (isset($end_date)) {print $end_date;} ?>' required readonly><br>
                </div>
                <div>
                    <label for='amount'>Amount</label>
                    <?php if(isset($msg_amount)) print $msg_amount; ?>
                    <input id='amount' name='amount' type='number' step='0.10'
                        value='<?php if (isset($amount)) {print $amount;} else { print '0';} ?>' required readonly><br>
                </div>
                <div>
                    <label for='amount_paid'>Amount paid</label>
                    <?php if(isset($msg_amount_paid)) print $msg_amount_paid; ?>
                    <input id='amount_paid' name='amount_paid' type='number' step='0.10'
                        value='<?php if (isset($amount_paid)) {print $amount_paid;} else { print '0';} ?>' required><br>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input id='issue_date' name='issue_date' type='date' placeholder='yyyy-mm-dd'
                        value='<?php if (isset($issue_date)) {print $issue_date;} ?>' readonly><br>
                </div>
                <div>
                    <label for='due_date'>Due date</label><br>
                    <?php if(isset($msg_due_date)) print $msg_due_date; ?>
                    <input id='due_date' name='due_date' type='date' placeholder='yyyy-mm-dd'
                        value='<?php if (isset($due_date)) {print $due_date;} ?>'><br>
                </div>
                <div>
