...
$base_file_name = 'settings_toll_type_value_listing';
...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<a href='settings_toll_type_value_save.php?settingstolltypeid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>✎</a> 
		<a href='settings_toll_type_value_view.php?settingstolltypeid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>☷</a> 
		</td>
		</tr>
		";
	}
...
<body id='page-listing'>
    ...
    <section id='sub-menu'>
        ...
        <div class='right-block'>
            ✢ <a href='settings_toll_type_value_save.php' target='overlay-iframe' onclick='overlayOpen();'>New Toll
                Type</a>
        </div>
    </section>
