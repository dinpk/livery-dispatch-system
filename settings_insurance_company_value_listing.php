...
$base_file_name = 'settings_insurance_company_value_listing';
...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<a href='settings_insurance_company_value_save.php?settingsinsurancecompanyid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>✎</a> 
		<a href='settings_insurance_company_value_view.php?settingsinsurancecompanyid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>☷</a> 
		</td>
		</tr>
		";
	}
...
<body id='page-listing'>
    ...
    <section id='sub-menu'>
        <div class='left-block'><img src="images/icons/set_insurance_companies.png"> settings - insurance companies
        </div>
        <div class='right-block'>
            ✢ <a href='settings_insurance_company_value_save.php' target='overlay-iframe' onclick='overlayOpen();'>New
                Insurance Company</a>
        </div>
    </section>
