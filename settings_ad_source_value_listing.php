...
$base_file_name = 'settings_ad_source_value_listing';
...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<a href='settings_ad_source_value_save.php?settingsadsourceid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>✎</a> 
		<a href='settings_ad_source_value_view.php?settingsadsourceid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>☷</a> 
		</td>
		</tr>
		";
	}
...
<html>
<head>
    <title>SETTINGS - AD SOURCES</title>
...
<body id='page-listing'>
    ...
    <section id='sub-menu'>
        ...
        <div class='right-block'>
            ✢ <a href='settings_ad_source_value_save.php' target='overlay-iframe' onclick='overlayOpen();'>New Add
                Source</a>
        </div>
    </section>
