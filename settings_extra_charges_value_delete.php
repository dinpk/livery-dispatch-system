...
$show_record = true;
if (isset($_GET['settings_extra_charges_valuesid'])) {
	$record_id = trim($_GET['settings_extra_charges_valuesid']);
	if (!is_numeric($record_id)) die('Invalid record id.');
	if (isset($_GET['delete'])) {
		$results = mysqli_query($dbcon, "DELETE FROM settings_extra_charges_values WHERE key_settings_extra_charges_values = $record_id");
		if ($results) {
...
<body id='page-delete' class='page_delete page_settings_extra_charges_values_delete'>
