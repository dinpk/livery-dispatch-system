...
$base_file_name = 'settings_vehicle_make_value_listing';
...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<a href='settings_vehicle_make_value_save.php?settingsvehiclemakeid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>✎</a> 
		<a href='settings_vehicle_make_value_view.php?settingsvehiclemakeid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>☷</a> 
		</td>
		</tr>
		";
	}
...
<body id='page-listing'>
    ...
    <section id='sub-menu'>
        ...
        <div class='right-block'>
            ✢ <a href='settings_vehicle_make_value_save.php' target='overlay-iframe' onclick='overlayOpen();'>New Vehicle Make</a>
        </div>
    </section>
