	...
	if ($results) {
		...
		while ($row = mysqli_fetch_assoc($results)) {
			...
			<td class='record-icons'>
				...
				<a href='customer_passengers_view.php?customer_passengersid=" . $row['key_customer_passengers'] . "' target='overlay-iframe3' onclick='overlayOpen3();'>View</a> 
			</td>
			</tr>
	...
	<main>
		<section id='search-forms'>
			<form method='get'>
					...
					<!-- <a href='customer_passengers_save.php' target='overlay-iframe3' onclick='overlayOpen3();'>Add new</a> -->
			</form>
		</section>
		<?php 
