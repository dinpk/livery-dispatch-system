...
if (isset($_GET['trips_messagesid'])) {
	...
	if (isset($_GET['delete'])) {
		$results = mysqli_query($dbcon, "DELETE FROM trips_messages WHERE key_trips_messages = $record_id");
		if ($results) {
...
<body id='page-delete' class='page_delete page_trips_messages_delete'>
