...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<a href='settings_payment_method_value_save.php?settings_payment_method_valuesid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>✎</a> 
		<a href='settings_payment_method_value_view.php?settings_payment_method_valuesid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>☷</a> 
		</td>
		</tr>
		";
	}
...
<body id='page-listing' class='page_listing page_settings_payment_method_values_listing'>
	...
	<section id='sub-menu'>
		...
		<div class='right-block'>
			✢ <a href='settings_payment_method_value_save.php' target='overlay-iframe' onclick='overlayOpen();'>New Payment Method</a>
		</div>
	</section>
