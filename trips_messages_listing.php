...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<a href='trips_messages_save.php?trips_messagesid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>✎</a> 
		<a href='trips_messages_view.php?trips_messagesid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>☷</a> 
		</td>";
		$table_rows = $table_rows . '</tr>';
	}
	$listing_html = "
