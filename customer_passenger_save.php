		...
		if (isset($record_id) && $error != 1) { // update
			...
			if ($results) {
				...
				<div class='center'>
					...
					<br>
					<p><a href='trip_save.php?id=" . $last_inserted_key . "&passenger=" . $first_name . " " .$last_name . "'>Add a new trip</a></p>
				</div>
				";
			} else {
        ...
        <form method='post'>
            ...
            <fieldset>
                <div>
                    ...
                    <small>
                        <a href='customer_passenger_select_company.php' target='overlay-iframe2'
                ...
                <div>
                    ...
                    <small>
                        <a href='customer_passenger_select_rate_package.php' target='overlay-iframe2'
                            onclick='overlayOpen2();'>Select</a> &nbsp;
                        <a href='#'
                ...
                <div>
                    ...
                    <small>
                        <a href='customer_passenger_select_billing_contact.php' target='overlay-iframe2'
                            onclick='overlayOpen2();'>Select</a> &nbsp;
                        <a href='customer_billing_contact_create.php' target='overlay-iframe2'
