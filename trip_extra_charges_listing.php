...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<small>
		<a href='trip_extra_charges_save.php?trip_extra_chargesid=$record_id&tripsid=$parent_id' target='overlay-iframe' onclick='overlayOpen();'>✎</a> 
		<a href='trip_extra_charges_view.php?trip_extra_chargesid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>☷</a> 
		</small>
		</td>
		</tr>
		";
...
<body id='page-listing' class='foreign'>
	...
	<section id='sub-menu'>
		...
		<div class='right-block'>
			✎ <a href='trip_extra_charges_save.php?tripsid=<?php print $parent_id; ?>' target='overlay-iframe' onclick='overlayOpen();'> New</a> 
		</div>
	</section>
