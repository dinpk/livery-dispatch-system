...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<td class='record-menus'>
			...
			<li><a href='customer_passengers_save.php?customer_passengersid=$record_id' target='overlay-iframe' onclick='overlayOpen();hide_record_menus();'>َEdit</a></li>
			<li><a href='customer_passengers_view.php?customer_passengersid=$record_id' target='overlay-iframe' onclick='overlayOpen();hide_record_menus();'>View</a></li>
			...
			<li><a href='trips_save.php?id=$record_id&passenger=" . $row['first_name'] . " " . $row['last_name'] . "' target='overlay-iframe' onclick='overlayOpen();hide_record_menus();'>New trip</a></li>
			<li><a href='trips_listing.php?customer_passengersid=$record_id' target='_blank' onclick='hide_record_menus();'>Trips</a></li>
			<li><a href='customer_invoices_listing.php?customer_passengersid=$record_id' target='_blank' onclick='hide_record_menus();'>Invoices</a></li>
			</ul>		 
		</td>
		</tr>";
	}
...
<body id='page-listing' class='page_listing page_customer_passengers_listing'>
	...
	<section id='sub-menu'>
		...
		<div class='right-block'>
			👤 <a href='customer_passengers_save.php' target='overlay-iframe' onclick='overlayOpen();'>New Passenger</a>
		</div>
	</section>
