...
if (isset($_GET['settings_staff_designation_valuesid'])) {
	...
	if (isset($_GET['delete'])) {
		...
		$results = mysqli_query($dbcon, "DELETE FROM `settings_staff_designation_values` WHERE `key_settings_staff_designation_values` = $record_id");
...
<body id='page-delete' class='page_delete page_settings_staff_designation_values_delete'>
