...
<head>
    ...
    function calculateTripRate {
        ...
        let pay_total_driver_amount = pay_driver_base_amount + pay_offtime_amount + pay_extra_stops_amount +
            pay_tolls_amount + pay_parking_amount + pay_gratuity_amount + pay_gas_surcharge_amount +
...
<body id='page-save'>
    ...
    <main>
        ...
        <form method='post'> <input id='key_drivers' name='key_drivers' type='hidden'
            ...
            <fieldset>
                ...
                <div>
                    <span>Zone rate</span>
                    <input class='input_number_small' id='zone_rate' type='number' value='<?php print $zone_rate; ?>'
                        readonly>
                </div>
                <div>
                    <div>Regular (rate,hours,minutes,amount)</div>
                    <input class='input_number_small' id='hourly_regular_rate' type='number'
                        value='<?php print $hourly_regular_rate; ?>' readonly>
                    <input class='input_number_small' id='regular_hours' type='number'
                        value='<?php print $regular_hours; ?>' readonly>
                    <input class='input_number_small' id='regular_minutes' type='number'
                        value='<?php print $regular_minutes; ?>' readonly>
                    <input class='input_number_small' id='hourly_regular_amount' type='number'
                        value='<?php print $hourly_regular_amount; ?>' readonly>
                </div>
                <div>
                    <div>Wait (rate,hours,minutes,amount)</div>
                    <input class='input_number_small' id='hourly_wait_rate' type='number'
                        value='<?php print $hourly_wait_rate; ?>' readonly>
                    <input class='input_number_small' id='wait_hours' type='number' value='<?php print $wait_hours; ?>'
                        readonly>
                    <input class='input_number_small' id='wait_minutes' type='number'
                        value='<?php print $wait_minutes; ?>' readonly>
                    <input class='input_number_small' id='hourly_wait_amount' type='number'
                        value='<?php print $hourly_wait_amount; ?>' readonly>
                </div>
                <div>
                    <div>Overtime (rate,hours,minutes,amount)</div>
                    <input class='input_number_small' id='hourly_overtime_rate' type='number'
                        value='<?php print $hourly_overtime_rate; ?>' readonly>
                    <input class='input_number_small' id='overtime_hours' type='number'
                        value='<?php print $overtime_hours; ?>' readonly>
                    <input class='input_number_small' id='overtime_minutes' type='number'
                        value='<?php print $overtime_minutes; ?>' readonly>
                    <input class='input_number_small' id='hourly_overtime_amount' type='number'
                        value='<?php print $hourly_overtime_amount; ?>' readonly>
                </div>
                <div>
                ...
                <table>
                    <tr>
                        <td>Off-time</td>
                        <td>
                            &nbsp;&nbsp;&nbsp;<input class='select_small' id='offtime_type' type='text'
                                value='<?php print $offtime_type; ?>' readonly>
                            <input class='input_number_small' id='offtime_amount' type='number'
                                value='<?php print $offtime_amount; ?>' readonly>
                        </td>
                    </tr>
                    <tr>
                        <td>Extra stops</td>
                        <td>
                            &nbsp;#<input class='input_number_small' id='extra_stops' type='number'
                                value='<?php print $extra_stops; ?>' readonly>
                            $<input class='input_number_small' id='extra_stops_amount' type='number'
                                value='<?php print $extra_stops_amount; ?>' readonly>
                        </td>
                    </tr>
                    <tr>
                        <td>Tolls</td>
                        <td>
                            &nbsp;&nbsp;&nbsp;<input class='select_small' id='toll_type' type='text'
                                value='<?php print $toll_type; ?>' readonly>
                            <input class='input_number_small' id='tolls_amount' type='number'
                                value='<?php print $tolls_amount; ?>' readonly>
                        </td>
                    </tr>
                    <tr>
                        <td>Parking</td>
                        <td>
                            &nbsp;&nbsp;&nbsp;<input class='input_number_small' id='parking_amount' type='number'
                                value='<?php print $parking_amount; ?>' readonly>
                        </td>
                    </tr>
                    <tr>
                        <td>Gratuity</td>
                        <td>
                            %<input class='input_number_small' id='gratuity_percent' type='number'
                                value='<?php print $gratuity_percent; ?>' readonly>
                            $<input class='input_number_small' id='gratuity_amount' type='number'
                                value='<?php print $gratuity_amount; ?>' readonly>
                        </td>
                    </tr>
                    <tr>
                        <td>Gas surcharge</td>
                        <td>
                            %<input class='input_number_small' id='gas_surcharge_percent' type='number'
                                value='<?php print $gas_surcharge_percent; ?>' readonly>
                            $<input class='input_number_small' id='gas_surcharge_amount' type='number'
                                value='<?php print $gas_surcharge_amount; ?>' readonly>
                        </td>
                    </tr>
                </table>
                <div>
                    <span>Extra charges</span>
                    <input id='trip_extra_charges' type='trip_extra_charges' value='<?php print $trip_extra_charges; ?>'
                        readonly>
                </div>
                <div>
            ...
            <fieldset>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            $<input class='input_number_small' id='pay_driver_base_amount' name='pay_driver_base_amount'
                                ...
                                value='<?php if (isset($pay_driver_base_amount)) {print $pay_driver_base_amount;} else {print '0';} ?>'
                                readonly>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            %<input class='input_number_small' id='pay_offtime_percent' name='pay_offtime_percent'
                                ...
                                value='<?php if (isset($pay_offtime_amount)) {print $pay_offtime_amount;} else {print '0';} ?>'
                                readonly>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            $<input class='input_number_small' id='pay_extra_stops_amount' name='pay_extra_stops_amount'
                                type='number' step='0.1'
                                value='<?php if (isset($pay_extra_stops_amount)) {print $pay_extra_stops_amount;} else {print '0';} ?>'
                                readonly>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            $<input class='input_number_small' id='pay_tolls_amount' name='pay_tolls_amount'
                                type='number' step='0.1'
                                value='<?php if (isset($pay_tolls_amount)) {print $pay_tolls_amount;} else {print '0';} ?>'
                                readonly>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            $<input class='input_number_small' id='pay_parking_amount' name='pay_parking_amount'
                                type='number' step='0.1'
                                value='<?php if (isset($pay_parking_amount)) {print $pay_parking_amount;} else {print '0';} ?>'
                                readonly>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            $<input class='input_number_small' id='pay_gratuity_amount' name='pay_gratuity_amount'
                                type='number' step='0.1'
                                value='<?php if (isset($pay_gratuity_amount)) {print $pay_gratuity_amount;} else {print '0';} ?>'
                                readonly>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            $<input class='input_number_small' id='pay_gas_surcharge_amount'
                                name='pay_gas_surcharge_amount' type='number' step='0.1'
                                value='<?php if (isset($pay_gas_surcharge_amount)) {print $pay_gas_surcharge_amount;} else {print '0';} ?>'
                                readonly>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            $<input class='input_number_small' id='pay_commission_amount' name='pay_commission_amount'
                                type='number' step='0.1'
                                value='<?php if (isset($pay_commission_amount)) {print $pay_commission_amount;} else {print '0';} ?>'
                                readonly>
                        </td>
                    </tr>
                </table>
                ...
                <div>
                    ...
                    <input id='pay_total_driver_amount' name='pay_total_driver_amount' type='number' step='0.1'
                        value='<?php if (isset($pay_total_driver_amount)) {print $pay_total_driver_amount;} else {print '0';} ?>'
                        readonly>
                </div>
                <br>
            ...
            <fieldset>
                <div>
                    ...
                    <input
                        <?php if (!isset($settled_checkbox) || $settled_checkbox=='on') {print "checked='checked'";} ?>
                        type='checkbox' id='settled_checkbox' name='settled_checkbox'> <label
                        for='settled_checkbox'>Settled</label><br>
                </div>
            </fieldset>
