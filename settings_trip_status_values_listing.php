...
$base_file_name = 'settings_trip_status_values_listing';
...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<a href='settings_trip_status_values_save.php?settings_trip_status_valuesid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>✎</a> 
		<a href='settings_trip_status_values_view.php?settings_trip_status_valuesid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>☷</a> 
		</td>
		</tr>
		";
	}
	$listing_html = "
		...
		<tr>
		<th><a href='$url" . $query_symbol . "sort_by=trip_status&sort_seq=$sql_order_by_seq'>Trip&nbsp;Status</a>" . (($sql_order_by == 'trip_status') ? $order_icon : '') . "</th>
		<th><a href='$url" . $query_symbol . "sort_by=sort&sort_seq=$sql_order_by_seq'>Sort</a>" . (($sql_order_by == 'sort') ? $order_icon : '') . "</th>
...
<html>
<head>
	<title>SETTINGS - TRIP STATUS VALUES</title>
	<?php include('php/_head.php'); ?>
</head>
<body id='page-listing' class='page_listing page_settings_trip_status_values_listing'>
	<?php include('php/_header.php'); ?>
	<section id='sub-menu'>
		<div class='left-block'><img src="images/icons/set_trip_statuses.png"> settings - trip statuses</div>
		<div class='right-block'>
			✢ <a href='settings_trip_status_values_save.php' target='overlay-iframe' onclick='overlayOpen();'>New Trip Status</a>
		</div>
	</section>
