...
<head>
	...
	<script>
		...
		function set_passenger_id_for_select_address(recordid) { // called from (1) trips_select_customer_passengers (2) bottom of this page
			document.getElementById("select_customer_address_link").href = "trip_select_customer_address_book.php?recordid=" + recordid;
		}
	...
	<form method='post'>
		...
		<fieldset id="trips_fieldset1">
			 ...
			 <div>
				 ...
				 <small>
						 <a href='trip_select_customer_passenger.php' target='overlay-iframe2' onclick='overlayOpen2();'>Select</a> &nbsp;
			 ...
			 <div>
				 ...
				 <small>
						 <a href='trip_select_customer_contact.php' target='overlay-iframe2' onclick='overlayOpen2();'>Select</a> &nbsp;
		...
		<fieldset id="trips_fieldset2">
			 ...
			 <div>
				 ...
				 <small>
						 <a href='trip_select_vehicle.php?rates_zonesid=<?php print $key_rates_zones; ?>' target='overlay-iframe2' onclick='overlayOpen2();'>Select</a> &nbsp;
			 ...
			 <div>
				 ...
				 <small>
						 <a href='trip_select_rate_zone.php' target='overlay-iframe2' onclick='overlayOpen2();'>Select</a> &nbsp;
		...
		<fieldset id="trips_fieldset3">
			 ...
			 <div>
				 <p>
					<small>
					<a href='trip_select_landmark.php' target='overlay-iframe2' onclick='overlayOpen2();'>Landmarks</a> &nbsp; 
					<!-- a function in <head> sets href for this link which is called from trip_select_customer_passenger.php -->
					<a id='select_customer_address_link' href='trip_select_customer_address_book.php' target='overlay-iframe2' onclick='overlayOpen2();'>Addressbook</a>
					</small>
				 </p>
