...
$base_file_name = 'settings_vehicle_type_value_listing';
...
if ($results) {
	...
	while ($row = mysqli_fetch_assoc($results)) {
		...
		<a href='settings_vehicle_type_value_save.php?settingsvehicletypeid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>✎</a> 
		<a href='settings_vehicle_type_value_view.php?settingsvehicletypeid=$record_id' target='overlay-iframe' onclick='overlayOpen();'>☷</a> 
		</td>
		</tr>
		";
	}
...
<html>
<head>
    <title>SETTINGS - VEHICLE TYPES</title>
